...
<Logo/>
   <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-[#0c0c0c]">
      <ul className="space-y-2 font-medium bg-gray-50 dark:bg-[#0c0c0c]">
         <li>
            <Link to={'/'} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               <BiHome/><span className="flex-1 ms-3 whitespace-nowrap">Home</span>
            </Link>
         </li>
         <li>
            <Link to={'/messages'} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               <BsInbox/>
