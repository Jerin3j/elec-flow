  ...
  return (
    ...
    <div className="Hit__Contents__row_1">
        <div className="Hit__Contents--1 flex flex-col gap-2">
            <h1 className="text-2xl md:text-4xl font-semibold font-rubik">1.</h1>
            <h1 className="md:text-lg text-xl font-rubik">User Registration:</h1>
        ...
        <div className="Hit__Contents--2 flex flex-col gap-2">
            <h1 className="text-2xl md:text-4xl font-semibold font-rubik">2.</h1>
            <h1 className="md:text-lg text-xl font-rubik">Finding Service Providers:</h1>
            <ul className='font-poppins'>
        ...
        <div className="Hit__Contents--3 flex flex-col gap-2">
            <h1 className="text-2xl md:text-4xl font-semibold font-rubik">3.</h1>
            <h1 className="md:text-lg text-xl font-rubik">Contact and Discuss:</h1>
            <ul className='font-poppins'>
    ...
    <div className="Hit__Contents__row__2">
        <div className="Hit__Contents--1 flex flex-col gap-2">
            <h1 className="text-2xl md:text-4xl font-semibold font-rubik">4.</h1>
            <h1 className="md:text-lg text-xl font-rubik">Scheduling Services:</h1>
        ...
        <div className="Hit__Contents--2 flex flex-col gap-2">
            <h1 className="text-2xl md:text-4xl font-semibold font-rubik">5.</h1>
            <h1 className="md:text-lg text-xl font-rubik">Payment and Reviews:</h1>
            <ol className='font-poppins'>
        ...
        <div className="Hit__Contents--3 flex flex-col gap-2">
            <h1 className="text-2xl md:text-4xl font-semibold font-rubik">6.</h1>
            <h1 className="md:text-lg text-xl font-rubik">Support and Safety:</h1>
            <ol className='font-poppins'>
