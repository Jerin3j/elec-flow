    ...
    <section className='Choose mt-12 md:mt-28'>
      <h1 className='font-poppins text-center font-bold text-2xl md:text-5xl text-[#010103] dark:text-[#F7F7F7]'>Why Choose Us</h1>
        ...
        <div className="choose__two flex flex-col gap-4 md:gap-9 mx-2 md:mx-0">
          <div className="choose_text-1 flex gap-2 md:gap-0">
          <img className='h-14 w-14 md:h-20 md:w-20 self-center' src={require('../../../Media/Icons/Experience.png')} alt="" />
            ...
            <div className="choose_text-2 flex gap-2 md:gap-0">
            <img className='h-14 w-14 md:h-20 md:w-20 self-center' src={require('../../../Media/Icons/CustomerApproach.png')} alt="" />
            <div className='flex flex-col gap-1 md:gap-3'>
            ...
            <div className="choose_text-2 flex gap-2 md:gap-0">
            <img className='h-14 w-14 md:h-20 md:w-20 self-center' src={require('../../../Media/Icons/Quality.png')} alt="" />
            <div className='flex flex-col gap-1 md:gap-3'>
